...
> 산출: ym-spec, 2026-07-20. 상태: **spec_done** (사용자 결정 Q1~Q7 대기)
> 브랜치 후보: `chore/observability` (PR 분할 시 `chore/observability-actuator` → `chore/observability-metrics` → `docs/observability-dashboard`)

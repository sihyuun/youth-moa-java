...
class ProgramServiceFilterTest {
    ...
    void searchByMultipleRegions() {
        Page<Program> result = programService.search("", List.of("수원시", "고양시"),
                Collections.emptyList(), "newest", 0);
    ...
    void searchByMultipleCenters() {
        Page<Program> result = programService.search("", Collections.emptyList(),
                List.of("내일스퀘어"), "newest", 0);
    ...
    void searchByRegionsAndCenters() {
        Page<Program> result = programService.search("", List.of("수원시"),
                List.of("내일스퀘어"), "newest", 0);
    ...
    void searchPopular() {
        Page<Program> result = programService.search("", Collections.emptyList(),
                Collections.emptyList(), "popular", 0);
    ...
    void sidebarRegionsFeaturedOnly() {
        ...
        assertThat(sidebar).extracting(Region::getName)
                .containsExactly("고양시", "수원시");
    }

 ...
 *
 * slot 은 고유 문자열 키(예: HERO_BANNER, HOME_SPACE_1) 로, 조회 시 slot 기반으로 접근한다.
 */
@Getter
@Entity
...
public class SiteImage {
    ...
    @Builder
    private SiteImage(String slot, String imageUrl, Integer sortOrder, Boolean isActive, String caption) {
        this.slot = slot;

    ...
    List<Program> seeds =
        List.of(
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 34세 청년").region("수원시").etc("입문자").build())
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("고양시").etc("영상 취미자").build())
                .startDate(today.minusDays(1))
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 34세 청년").region("용인시").etc("전 회차 참여").build())
                .startDate(today.minusDays(2))
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 34세 청년").region("성남시").etc("Java 경험자").build())
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("이천시").etc("초보 환영").build())
                .startDate(today.plusDays(3))
                .endDate(today.plusDays(3))
                .capacity(12)
                .build(),
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("김포시").etc("사회초년생 대상").build())
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("광명시").etc("취업 준비생").build())
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 34세 청년").region("화성시").etc("데이터 관심자").build())
                .startDate(today.plusDays(14))
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 34세 청년").region("파주시").etc("디자인 관심자").build())
                .startDate(today.minusDays(2))
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("의정부시").etc("전 레벨 환영").build())
                .startDate(today.minusDays(3))
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("남양주시").etc("사진 취미자").build())
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("시흥시").etc("책 좋아하는 청년").build())
                .startDate(today.minusDays(30))
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 34세 청년").region("평택시").etc("음악 활동자").build())
            ...
            Program.builder()
                ...
                .eligibility(
                    ProgramEligibility.builder().age("만 19세 ~ 39세 청년").region("하남시").etc("환경 관심자").build())
                .startDate(today.plusDays(21))

    ...
    public void run(ApplicationArguments args) {
        ...
        List<Program> seeds = List.of(
                Program.builder()
                        .title("취업역량 강화 워크숍")
                        .organization("내일스퀘어")
                        /*.category("취업") Q2-2026-06-30 보류*/.region("부천시")
                ...
                Program.builder()
                        .title("청년 창업 아카데미")
                        .organization("상상대로")
                        /*.category("창업") Q2-2026-06-30 보류*/.region("수원시")
                ...
                Program.builder()
                        ...
                        /*.category("힐링") Q2-2026-06-30 보류*/.region("안양시")
                ...
                Program.builder()
                        .title("디지털 마케팅 실전반")
                        .organization("원미청정구역")
                        /*.category("교육") Q2-2026-06-30 보류*/.region("부천시")
                ...
                Program.builder()
                        .title("AI 활용 실무 교육")
                        .organization("비행지구")
                        /*.category("교육") Q2-2026-06-30 보류*/.region("고양시")
                ...
                Program.builder()
                        .title("소셜벤처 인큐베이팅")
                        .organization("오름")
                        /*.category("창업") Q2-2026-06-30 보류*/.region("용인시")
                ...
                Program.builder()
                        .title("청년 문화예술 스쿨")
                        .organization("고천센터")
                        /*.category("교육") Q2-2026-06-30 보류*/.region("의왕시")
                ...
                Program.builder()
                        .title("청년 네트워킹 데이")
                        .organization("이루잡")
                        /*.category("창업") Q2-2026-06-30 보류*/.region("화성시")

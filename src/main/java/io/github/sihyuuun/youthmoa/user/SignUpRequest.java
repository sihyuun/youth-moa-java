 ...
 * <ol>
 *   <li>{@link RequiredCheck} — NotBlank / NotNull (입력 여부)</li>
 *   <li>{@link FormatCheck} — Size / Pattern / Email / AssertTrue (형식·정책)</li>
 * </ol>
 * Controller 에서 {@code @Validated(SignUpRequest.OrderedChecks.class)} 적용 시
 * {@link RequiredCheck} 가 실패한 필드는 {@link FormatCheck} 검증을 건너뛴다.
 */
@Getter
@Setter

...
public class ProgramSpec {
  ...
  /**
   * 통합 검색 키워드 매칭 — title / center.name / region / content 4개 컬럼 OR LIKE. 대소문자 무시. q 가 null/빈 문자열이면
   * 조건 없음(cb.conjunction) 반환하여 다른 Specification 과 안전하게 결합.
   *
   * <p>A9-b (2026-09-22): organization 컬럼 DROP → center.name join 으로 대체. Program.center 는 NOT NULL
   * 이므로 inner join 안전.
   *

 ...
 *
 * <p><b>임시 하드코딩 구현</b> (2026·2027). jollyday 라이브러리는 Maven Central 좌표 확인 후 별도 티켓에서 전환 예정. 하드코딩 대상:
 * 신정, 삼일절, 어린이날, 현충일, 광복절, 개천절, 한글날, 성탄절 (고정일) + 음력 공휴일 (설날 연휴 3일, 추석 연휴 3일, 부처님오신날) 은 연도별 실 날짜 지정.
 *
